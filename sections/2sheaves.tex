...
In algebraic geometry, one usually restricts attention to a certain class of
...
\begin{prop}[Lemma 7.2.7 in \cite{gathmann}]\label{prop:qcoh_gsec_exact}
  Given an affine variety $X$ and a SES
  \[\begin{tikzcd}
...
\end{prop}
\begin{proof}
  By Lemma~\ref{lemm:qcoh_local_global}, I need to check the exactness of the
  sequence
  \[\begin{tikzcd}
  ...
  Thm.~\ref{thm:ses_equivalence} with Lemma~\ref{lemm:qcoh_local_global},
